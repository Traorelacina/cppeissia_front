    ...
    <Box>
      ...
      <Box sx={{ background: 'linear-gradient(135deg, #0f4a25, #1B7A3E)', py: { xs: 8, md: 12 }, px: 3 }}>
        <Container maxWidth="md" sx={{ textAlign: 'center' }}>
          <Typography sx={{ fontSize: 14, fontWeight: 700, color: ORANGE, letterSpacing: '3px', textTransform: 'uppercase', mb: 1.5 }}>
            Notre établissement
          </Typography>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="stretch">
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Box sx={{
                background: '#f8fbf9', borderRadius: '24px', p: 3.5,
                ...
                {infos.map(({ icon: Icon, titre, desc }, idx) => (
                  <Box key={titre}>
                    <Box sx={{ display: 'flex', gap: 2, py: 2 }}>
                      <Box sx={{ width: 48, height: 48, borderRadius: '14px', background: '#fff', boxShadow: '0 4px 12px rgba(27,122,62,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ height: '100%', position: 'relative' }}>
                <Box sx={{ position: 'relative', height: '100%', minHeight: 320, borderRadius: '24px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,40,20,0.25)' }}>
                  <Box
                    component="img"
                    ...
                    sx={{
                      ...
                      transition: 'transform 8s ease', '&:hover': { transform: 'scale(1.08)' },
                    }}
                  />
                  <Box sx={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '60%', background: 'linear-gradient(to top, rgba(10,46,24,0.92) 0%, transparent 100%)', pointerEvents: 'none' }} />
                  <Box sx={{ position: 'absolute', bottom: 20, left: 20, right: 20, zIndex: 3 }}>
                    <Typography sx={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 18, fontWeight: 700, color: '#fff', lineHeight: 1.3, mb: 0.5 }}>
                      Complexe Socio-Éducatif d'Issia
                    </Typography>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Box sx={{ width: 8, height: 8, borderRadius: '50%', background: ORANGE, flexShrink: 0 }} />
                      <Typography sx={{ fontSize: 14, color: 'rgba(255,255,255,0.85)', fontWeight: 500, letterSpacing: '0.3px' }}>
